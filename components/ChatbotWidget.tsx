    ...
    return (
        <>
            <motion.div className="fixed bottom-4 right-4 z-50">
                {/* Floating button with enhanced animations - More professional size */}
                <motion.button
                    onClick={toggleChat}
                    className="relative w-12 h-12 bg-gradient-to-br from-indigo-600 to-purple-600 text-white rounded-full shadow-lg flex items-center justify-center overflow-hidden"
                    whileHover={{ 
                        scale: 1.1,
                ...
                >
                    ...
                    {/* Notification dot - smaller for professional look */}
                    <AnimatePresence>

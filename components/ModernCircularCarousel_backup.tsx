...
import { ChevronLeftIcon, ChevronRightIcon, ExternalLinkIcon, CloseIcon } from './icons/UIIcons';
      ...
      <AnimatePresence>
        {isModalOpen && selectedProject && (
          ...
          >
            ...
            <motion.div
              className="relative w-full max-w-[95vw] max-h-[95vh] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border border-slate-600/50 rounded-3xl shadow-2xl overflow-hidden z-[10000] mx-auto"
            ...
            >
              <div className="flex flex-col lg:flex-row h-full min-h-[600px] max-h-[95vh]">
                ...
                <div className="lg:w-1/3 bg-gradient-to-b from-slate-800/80 to-slate-900/80 backdrop-blur-sm border-l border-slate-600/50">
                  ...
                  <div className="p-10 h-full flex flex-col justify-between">
                    <div>
                      ...
                      >
                        <h3 className="text-lg font-semibold text-slate-300 mb-4">Tech Stack</h3>
                        <div className="flex flex-wrap gap-3">
                          {selectedProject.tags.map((tag, i) => (
                            <motion.span 
                              key={i}
                              className="px-4 py-2 bg-slate-700/60 text-purple-300 rounded-full border border-slate-600/50 text-sm font-medium"
                    ...
                    >
                      {selectedProject.liveUrl && (
                        <motion.a 
                          ...
                          className="flex-1 bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-lg font-semibold text-center hover:from-purple-700 hover:to-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
